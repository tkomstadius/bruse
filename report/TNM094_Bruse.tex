...
\begin{table}[h]
  \begin{centering}
    ...
    \hline
    \end{tabular}
    \captionof{table}{Typografiska konventioner i rapporten}
    \label{table:type}
  \end{centering}
\end{table}
...
\begin{table}[h]
  \begin{centering}
    ...
    \hline
    \end{tabular}
    \captionof{table}{Ofta användna förkortningar}
    \label{table:abbr}
  \end{centering}
\end{table}
...
\begin{Figure}
  ...
  \centering
    ...
    % caption! change the label ref to what you want
    \captionof{figure}{\emph{Statistik från Github.}\label{fig:gitstats}}
\end{Figure}
...
\includepdf[pages=-]{appendix/gantt.pdf}
\chapter{Scenarion}
\label{appendix:scenarion}
\includepdf[pages=-]{appendix/scenarion.pdf}
